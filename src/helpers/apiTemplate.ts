 ...
 * @returns Url of api
 */
export const youtube_channel_live_stream_viewers_count = (video_id: string, api_key: string) => `${url_prefix}videos?part=liveStreamingDetails&id=${video_id}&fields=items%2FliveStreamingDetails%2FconcurrentViewers&key=${api_key}`
